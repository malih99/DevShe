        ...
        <div className="max-w-5xl mx-auto space-y-16">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed text-sm mt-2">
              ...
              پروژه‌های واقعی. مسلط به طراحی رابط کاربری با TailwindCSS و
              ابزارهای مدیریت State مانند Zustand و React Query. علاقه‌مند به
              یادگیری مستمر، مستندسازی و کار در محیط‌های چالشی.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="text-sm mt-2">
              ...
              <p className="text-gray-400">
                کارشناسی مهندسی شیمی (1399 - 1403)
              </p>
            </div>
          </section>
